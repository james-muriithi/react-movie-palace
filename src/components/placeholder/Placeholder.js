            ...
            <div className="card__content">
                <div className="d-flex align-items-center" >
                    <h3 className="card__title">
                        <ContentLoader speed={2} backgroundColor="transparent" foregroundColor="rgba(255, 255, 255, 0.1)" height="10px" style={{ width: "100%" }}>
                ...
                <div className="card__wrap">
                    ...
                    <ul className="card__list">
                        <ContentLoader speed={2} backgroundColor="transparent" foregroundColor="rgba(255, 255, 255, 0.1)" style={{ height: '30px', width: '100%' }}>
